...
import { getAdminStats, getAllUsers, toggleUserStatus, getAllResources, verifyResource } from '../../api/resourcesAPI';
...
console.log(resources);
  ...
  const loadDashboardData = async () => {
    try {
      setLoading(true);
      const [statsResponse, usersResponse, resourcesResponse] = await Promise.all([
        getAdminStats(),
        getAllUsers(),
        getAllResources()
      ]);
    ...
    <div className="space-y-6 p-6">
      ...
      {activeTab === 'overview' && stats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="p-6 text-center">
            <div className="text-3xl mb-2">✅</div>
            <div className="text-2xl font-bold text-green-600">{stats.verified_resources}</div>
            <div className="text-gray-500">Verified Resources</div>
          </Card>
        </div>
      )}

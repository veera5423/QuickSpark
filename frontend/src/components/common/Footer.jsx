      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <span className="text-xl font-bold">⚡ Quick Spark AI</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Revolutionize your learning with AI-powered tools for summarization, quiz generation, and skill tracking.
              Enhance your educational journey with cutting-edge technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-gray-400">AI Summarization</span></li>
              <li><span className="text-gray-400">Smart Quizzes</span></li>
              <li><span className="text-gray-400">Progress Tracking</span></li>
              <li><span className="text-gray-400">Skill Assessment</span></li>
              <li><span className="text-gray-400">Career Explorer</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {currentYear} QuickSpark AI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
